...
static void mainWindowInit(Window *window){
  ...
  ///////////////Set up Time//////////////////////////
  //set text layer
  timeLayer = text_layer_create(GRect(0,47, 144, 50));
  //set colors
  ...
  dateLayer = text_layer_create(GRect(0, 97, 144, 50));
  //set colors
  text_layer_set_background_color(dateLayer, GColorClear);
  text_layer_set_text_color(dateLayer, GColorWhite);
  //set fonts
  text_layer_set_font(dateLayer, fonts_get_system_font(FONT_KEY_BITHAM_30_BLACK));
  ...
  /////////////Set up Day/////////////////////////////////////
  //create text layer
  dayLayer = text_layer_create(GRect(0,15, 144,50));
  //set colors
  text_layer_set_background_color(dayLayer, GColorClear);
  text_layer_set_text_color(dayLayer, GColorWhite);
  //set fonts
  text_layer_set_font(dayLayer, fonts_get_system_font(FONT_KEY_BITHAM_30_BLACK));
...
static void updateTime(){
  ...
  ////////////Set up Date//////////////////////////////
  //buffer to hold date
  static char dateBuffer[] = "June 25";
  //format date
